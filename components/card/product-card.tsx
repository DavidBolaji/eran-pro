...
export const ProductCard: React.FC<{
  product: Product & { category: Pick<Category, "name"> };
}> = ({ product }) => {
  const isOnSale = product.status === "ACTIVE";
  return (
    <div
      key={product.id}
      className="min-w-[328px] min-h-[462px] border relative rounded-2xl bg-white shadow-md shrink-0"
    >
      {isOnSale && (
      ...
      <div className="h-64 bg-gray-800 rounded-t-2xl mb-4"></div>
      <div className="px-4">
